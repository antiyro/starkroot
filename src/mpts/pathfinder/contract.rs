...
use crate::mpts::pathfinder::merkle_node::InternalNode;
use crate::mpts::pathfinder::tree::{MerkleTree, Visit};
use crate::mpts::pathfinder::storage;
...
impl storage::Storage for ContractStorage<'_> {
...
impl storage::Storage for StorageTrieStorage<'_> {
    fn get(&self, index: u64) -> anyhow::Result<Option<pathfinder_storage::StoredNode>> {
